...
indir="/project/g_bme-janeslab/SarahG/julia_out/CPC_geometry/CPC_domain_0_1_e_0.0075_monse_quant"

OPTS=$(sed -n "${SLURM_ARRAY_TASK_ID}"p CPC_geometric_array_eps_0.0075_monse_quant_v3.txt)
dtout=10
...
name="phi_${nx}_${timesteps}_1.0e-5__CPC_${CPC}_cohesin_${cohesin}_eps_0.0075_domain_0_1_${suffix}"
echo $name 
outdir="$indir/$name"
echo $outdir
