...
function initialize_round_CPC_um(nx, ny; CPC_width=0.173, cohesin_width=0.2, domain_width=3.2, phi1 = -1.0, phi2 = 1.0)
...
function initialization(nx, ny; method="spinodal", initial_file="", delim=',', h=1 / 128, R0=0.1, gam=0.01, cohesin_width=4, CPC_width=20)
    if method == "random"
