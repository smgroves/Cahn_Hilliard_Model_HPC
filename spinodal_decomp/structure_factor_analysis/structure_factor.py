...
def plot_coarsening_law(t, l, t_min=None, t_max=None, figsize=(10, 7)):
    ...
    # All data
    ax.loglog(t, l, 'o-', color='steelblue', linewidth=2, markersize=7,
    ...
    ax.loglog(t_fit, l_pred, 's--', color='coral', linewidth=2.5, markersize=5,
    ...
    l_theory = scale * (t_theory ** (1/3))

    ax.loglog(t_theory, l_theory, ':', color='green', linewidth=2.5, alpha=0.8,
