function [rr, tt] = level_set_plot_alpha(dt, indir, total_time, everyR, epsilon_name, R0, folder, alpha)
    timesteps=total_time/dt;
    alpha
    name=sprintf('phi_128_%s_1.0e-6__R0_%s_eps_%s_alpha_%s',string(timesteps), R0, epsilon_name, alpha)
    dtout=10;
    Nx = 2^7;Ny=2^7;
    hx = 1/Nx;
    hy = 1/Ny;
